...
MASTER_DEFAULT_HEADERS = ["No.", "Material Code", "CML Reagent", "Supplier",
                          ...
                          "Supplier Material Code", "Tests per pack"]
...
class Sheets:
    ...
    def _read_master_tab(self, tab, category):
        ...
        ci = {
            ...
            "pack": idx("pack", "unit"),
            # Optional override. Left blank the bot reads the pack size out
            # of the Pack text, and declines to compare when that is not
            # unambiguous.
